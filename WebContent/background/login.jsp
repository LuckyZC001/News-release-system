...
<title>News release system background login</title>
<!--                       CSS                       -->
<!-- Reset Stylesheet -->
...
<script type="text/javascript">
	function checkForm(){
		...
		if(userName==null||userName==""){
			document.getElementById("error").innerHTML="User name cannot be empty!";
			return false;
		}
...
<div id="login-wrapper" class="png_bg">
  ...
  <div id="login-content">
    <form action="${pageContext.request.contextPath}/user?action=login" method="post" onsubmit="return checkForm()">
      ...
      <div class="clear"></div>
       <font id="error" color="red">${error }</font>   <input class="button" type="submit" value="login" />
    </form>
  </div>
  <!-- End #login-content -->
</div>

  ...
  <LI>5</LI></UL></DIV>
		...
		<div class="newsHeader_list">
			<div class="newsHeader">
				...
				<p>${fn:substring(headNews.content,0,40) }...<a href="news?action=show&newsId=${headNews.newsId }" >[Read More]</a></p>
			</div>
			<div class="currentUpdate">
				<div class="currentUpdateHeader">Recent updates</div>
	...
	<div class="span3">
		<div class="data_list hotspot_news_list">
			<div class="dataHeader">Hot news</div>
			<div class="datas">
				<ul>
	...
	<c:forEach var="indexNews" items="${allIndexNews }" varStatus="oneStatus">
		<c:if test="${oneStatus.first }">
			...
			<div class="data_list news_list" >
				<div class="dataHeader">${newsTypeList.get(allStatus.index).typeName }<span class="more"><a href="news?action=list&typeId=${newsTypeList.get(allStatus.index).newsTypeId }">More</a></span></div>
				<div class="datas">
					<ul>
		</c:if>

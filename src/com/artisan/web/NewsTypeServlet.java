...
public class NewsTypeServlet extends HttpServlet{
	...
	private void newsTypePreSave(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			if(StringUtil.isNotEmpty(newsTypeId)){
				request.setAttribute("navCode", NavUtil.genNewsManageNavigation("Category management", "Category to modify"));
			}else{
				request.setAttribute("navCode", NavUtil.genNewsManageNavigation("Category management", "Category to add"));
			}
	...
	private void newsTypeBackList(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			request.setAttribute("navCode", NavUtil.genNewsManageNavigation("Category management", "Category maintenance"));
	...
	private void newsTypeDelete(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			if(exist){
				result.put("errorMsg", "There is news under this news category. This news category cannot be deleted!");
			}else{

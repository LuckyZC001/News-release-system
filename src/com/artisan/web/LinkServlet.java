...
public class LinkServlet extends HttpServlet{
	...
	private void linkBackList(HttpServletRequest request,
		...
		try{
			...
			request.setAttribute("navCode", NavUtil.genNewsManageNavigation("Link management", "Link maintenance"));
	...
	private void linkPreSave(HttpServletRequest request, HttpServletResponse response)
		...
		try{
			...
			if(StringUtil.isNotEmpty(linkId)){
				request.setAttribute("navCode", NavUtil.genNewsManageNavigation("Link management", "Link modification"));
			}else{
				request.setAttribute("navCode", NavUtil.genNewsManageNavigation("Link management", "Link addition"));
			}
